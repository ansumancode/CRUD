  ...
  return (
    <>
        <div className="flex justify-between items-center mb-6">
            ...
            <p className="text-base text-black">Step 1</p>
          </div>
          <Formik validationSchema={setpOneValidation} initialValues={props.data} onSubmit={handelSubmit}>
            ...
            <Form className="w-full max-w-lg">
              <div className="flex flex-wrap mb-6">
                <div className="w-full mb-6">
                  ...
                  />
                  <p className="text-red-500 text-xs italic"><ErrorMessage name="jobTitle" /></p>
                </div>
                <div className="w-full mb-6">
                  ...
                  />
                  <p className="text-red-500 text-xs italic"><ErrorMessage name="company" /></p>
                </div>
                <div className="w-full mb-6">
                  <label className="block tracking-wide text-sm font-medium mb-1 relative text-black">
                    Industry
                  ...
                  />
                  <p className="text-red-500 text-xs italic"><ErrorMessage name="industry" /></p>
                </div>
              ...
              <button type="submit" className="bg-blue-500 hover:bg-blue-700 text-white text-base py-1 px-3 rounded-md ">Next</button>
              </div>
            </Form>
          </Formik>
    </>
